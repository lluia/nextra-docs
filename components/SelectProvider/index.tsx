          ...
          <>
            ...
            <div className="mt-8 flex flex-row gap-6 pb-8">
              <div
                ...
                className="p-4 border border-solid dark:border-neutral-800 border-slate-200 rounded-lg flex flex-col items-center justify-between w-32 shadow-lg h-32 hover:bg-slate-50 transition-colors"
              >
