          ...
          >
            {items.map((item) => (
              <Ariakit.ComboboxItem
                className="flex flex-row gap-4 items-center py-2 px-2 cursor-pointer aria-selected:bg-purple-200/50 dark:aria-selected:text-neutral-200 dark:aria-selected:bg-neutral-950"
                value={item.name}
                key={item.name}
          ...
          <>
            ...
            <div className="flex flex-row gap-6 pb-8 mt-8">
              <div
                ...
                className="flex flex-col justify-between items-center p-4 w-32 h-32 rounded-lg border border-solid shadow-lg transition-colors border-neutral-200 dark:border-neutral-600 dark:hover:bg-neutral-600 hover:bg-slate-50"
              >
              ...
              <div
                ...
                className="flex flex-col justify-between items-center p-4 w-32 h-32 rounded-lg border border-solid shadow-lg border-neutral-200 transition-color dark:border-neutral-600 dark:hover:bg-neutral-600 hover:bg-neutral-50"
              >
              ...
              <div
                ...
                className="flex flex-col justify-between items-center p-4 w-32 h-32 rounded-lg border border-solid shadow-lg transition-colors border-neutral-200 dark:border-neutral-600 dark:hover:bg-neutral-600 hover:bg-neutral-50"
              >
                <img
