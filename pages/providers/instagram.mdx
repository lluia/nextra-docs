...
>
  <span>
    Built-in <b>Instagram</b> integration.
  </span>
  <a href="https://www.instagram.com/">
    <img
      style={{ display: "block" }}
      src="/img/providers/instagram.svg"
      height="48"
      width="48"
    />
  </a>
...
<Callout>
  ...
  configuration](https://github.com/nextauthjs/next-auth/blob/main/packages/core/src/providers/instagram.ts).
