...
<Callout type="info">
  ...
  sessions, but you **must** configure a database to use it. It is not possible
  to enable email sign in without using a database.
</Callout>
...
```js {3} filename="pages/api/auth/[...nextauth].js"
...
```js {7} filename="pages/api/auth/[...nextauth].js"
import EmailProvider from "next-auth/providers/email";
...
<Callout type="info">
  If you want to generate great looking email client compatible HTML with React,
