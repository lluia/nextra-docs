...
- Auth.js has no opinion on the type of database you are using, we have a big list of [official database adapters](/overview/database-setup), but you can [implement your own](/tutorials/cusomt-adapter) as well
