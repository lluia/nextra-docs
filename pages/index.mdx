...
<div className="flex flex-row justify-around w-full mt-8 mb-12">
  {[
    ...
    },
    {
      ...
      logoWidth: "35",
      wip: true,
      label: "Officially supported. Missing documentation. Help us document it."
    },
    {
...
<ListDisclosure
  limit="8"
  className="grid gap-x-8 gap-y-4 grid-cols-4 w-full mt-8 mb-12"
>
...
<ListDisclosure
  limit="8"
  className="grid gap-x-4 gap-y-4 grid-cols-4 w-full mt-8 mb-12"
>
