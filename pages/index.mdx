...
<div className="flex flex-row justify-around w-full mt-8 mb-12">
  ...
  ].map(({ href, name, img, logoWidth }) => (
    <Link
      href={href}
      key={href}
      className="p-4 border border-solid border-slate-200 rounded-lg flex flex-col items-center justify-between w-28 shadow-lg"
    >
...
Continue to our guides to see how to use Auth.js:
