...
<Callout type="info">
  ...
  adapter](/getting-started/adapters) to use it. It is not possible to enable
...
<img src="/img/magic-links/dashboard-smtp.png" />

### Configuring Auth.js

Next, as [per Sendgrid documentation](https://docs.sendgrid.com/for-developers/sending-email/integrating-with-the-smtp-api), let's add the following [environment variables](https://Next.js.org/docs/basic-features/environment-variables) in our Next.js app:
...
Open `pages/api/auth/[...nextauth].ts` and add the following:
...
And navigating to [`http://localhost:3000`](http://localhost:3000). Click on "Sign in" and you should be redirected to the sign in page:
...
<img src="/img/magic-links/check.png" alt="Screenshot of check email page" />

Lets go to our mailbox, and look for an email sent from Auth.hjs (check your spam folder 📁 just in case):

<br />
<img src="/img/magic-links/mailbox.png" alt="Screenshot of mailbox" />
...
<img src="/img/magic-links/logged.png" alt="Screenshot of logged in" />
