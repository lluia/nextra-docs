...
<Callout>
  ...
  [Middleware](/overview/securing/middleware#redirecting-users) to redirect the
  user based on their role, even before rendering the page.
</Callout>

## Resources

- [Concepts: Session strategies](/concepts/session-strategies)
- [Adapters: User model](/overview/database-setup#user-model)
- [Adapters: Prisma adapter](/reference/adapter/prisma)
- [Next.js: Middleware](/overview/securing/middleware)
