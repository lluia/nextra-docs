...
<Callout type="info">
  ...
  sessions, but you [must configure a database adapter](/getting-started/database) to use
...
Next, as [per Sendgrid documentation](https://docs.sendgrid.com/for-developers/sending-email/integrating-with-the-smtp-api), let's add the following [environment variables](https://Next.js.org/getting-started/basic-features/environment-variables) in our Next.js app:
