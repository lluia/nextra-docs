...
verification hashes. (See [Deployment](/docs/deployment) to learn more). You can generate one via running:
...
otherwise you can skip on to the next section, [Authentication](/docs/authentication), to setup your first authentication method.
