...
<Callout>
  ...
  [Middleware](/docs/securing/middleware#redirecting-users) to redirect the user
  based on their role, even before rendering the page.
</Callout>

## Resources

- [Concepts: Session strategies](/docs/session-management)
- [Adapters: User model](/docs/database#user-model)
- [Adapters: Prisma adapter](/reference/adapter/prisma)
- [Next.js: Middleware](/docs/securing/middleware)
