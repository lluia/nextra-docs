...
For signing in users, assuming you have [already setup an authentication method](/docs/authentication), you only need to build a button that when pressed calls the `signIn` function exported in your Auth.js config:
