...
import TypesDocumentation from "../../public/img/etc/types-documentation.webp";

<Screenshot src={TypesDocumentation} alt="Types Documentation" />

## Philosophy

We have chosen [module augmentation](https://www.typescriptlang.org/getting-started/handbook/declaration-merging.html#module-augmentation) over [generics](https://www.typescriptlang.org/getting-started/handbook/2/generics.html) as the main technique to type Auth.js resources across your application in case you extend them.

<details>
<summary>
<b>Why not use <a href="https://www.typescriptlang.org/getting-started/handbook/2/generics.html">generics</a>?</b>
</summary>
...
Good examples of such interfaces are `Session` or `User`. You can use TypeScript's [Module Augmentation](https://www.typescriptlang.org/getting-started/handbook/declaration-merging.html#module-augmentation) to extend these types to add your own properties across Auth.js without having to pass generic all over the place.
...
1. [TypeScript documentation: Module Augmentation](https://www.typescriptlang.org/getting-started/handbook/declaration-merging.html#module-augmentation)
...
3. [Creating a Database Adapter](#TODO)
