...
- [OAuth authentication](/docs/providers/oauth-tutorial) ( _Sign in with Google, Github, LinkedIn, etc..._ )
- [Token-based authentication](/docs/providers/email-tutorial) ( _Magic links, OTP codes, etc..._ )
- [Credentials](/docs/providers/credentials-tutorial) ( _Integrating with external APIs,
  WebAuthn, etc..._ )
...
<Callout>
  ...
  application, check out [session management](/docs/session-management) for more
  details.
</Callout>
...
<Callout type="info">
  ...
  interface](/docs/typescript#module-augmentation) to match the response of your
  `authorize` callback, so whenever you read the user in other callbacks (like
  the `jwt`) the type will match correctly.
</Callout>
...
your setup is working. See the next section, [Session management](/docs/session-management),
