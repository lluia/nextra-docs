...
- OAuth support on preview deployments: [Read more](/docs/deployment#securing-a-preview-deployment).
...
<Callout type="info">
  ...
  adapter](/docs/creating-a-database-adapter) guide to learn how to create your
  own.
</Callout>
