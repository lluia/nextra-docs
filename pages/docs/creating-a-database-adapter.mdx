...
See also: [User](/docs/adapters#user) and [Account](/docs/adapters#account) models.
...
See also: [Session](/docs/adapters#session) models.
...
See also: [Verification Token](/docs/adapters#verification-token) models.
