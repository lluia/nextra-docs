...
<img src="/img/tutorials/example-app.png" />
...
you'll then be presented with <u>Auth.js built-in sign in page</u>:

<img src="/img/tutorials/sign-in-page.png" />
...
import { SignInWith } from "../../../components/sign-in-with";
...
<img
  src="/img/tutorials/custom-sign-in-page.png"
