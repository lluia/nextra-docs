...
>
  <p style={{ fontWeight: "normal" }}>
    Official <a href="https://mikro-orm.io/docs/installation">MikroORM</a>{" "}
    adapter for Auth.js / NextAuth.js.
  </p>
  <a href="https://mikro-orm.io/">
    <img
      style={{ display: "block" }}
      src="https://authjs.dev/img/adapters/mikro-orm.svg"
      width="140"
    />
  </a>
</div>
...
```typescript filename="pages/api/auth/[...nextauth].ts"
