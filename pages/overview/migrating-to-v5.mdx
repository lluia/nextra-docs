...
**NextAuth.js version 5** is a major rewrite of the package, but we made
sure to introduce as little breaking changes as possible. For anything else,
...
- Edge-compatible
- There is a new `account()` callback on providers which allow you to pass in data from the
...
- Minimum required Next.js version is now [14.0](https://nextjs.org/14).
