...
For instance, when implementing magic links, the [Email Provider](/getting-started/providers/email-tutorial) will require you to setup a database adapter to be able to store the [verification tokens](#verification-token) present on the links.
