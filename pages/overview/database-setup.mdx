...
For instance, [when implementing magic links](/tutorials/paswordless-sentry-setup), the `EmailProvider` will require you to setup a database adapter to be able to store the [verification tokens](#verificationtoken-model) present on the links.
