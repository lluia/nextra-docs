...
<Callout type="info">
  The `@auth/core` package is designed for new framework integrations. As a
  consumer of the library, you should never need to install it.
</Callout>
...
can skip on to the next section, [Authentication](/overview/authentication), to setup your first authentication method.
