...
Auth.js is automatically configured to read these, so you don't need to make any changes in your configuration file. The shape of these variables in the environment is always the same:
