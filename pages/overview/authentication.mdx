...
Please make sure you've [setup a database adapter](/overview/database-setup), as mentioned earlier, a database is required for paswordless login to work as verification tokens need to be stored.
...
<img
  className="mb-12"
  src="/img/getting-started/session-working.png"
  alt="Auth.js Session"
/>
