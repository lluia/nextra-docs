...
This should serve for now as proof that the user is authenticated and Auth.js is working. Refer to the next section, [Session management](/overview/session-management), to learn how to display and manage the user session in your app.
