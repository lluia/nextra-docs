...
<a href="https://github.com/balazsorban44">Balázs Orbán</a> created Auth.js based
on NextAuth.js, a runtime/framework independent core library that is the base of
all Auth.js libraries going forward.
