...
<a
  className="flex items-center justify-start gap-4 text-3xl mt-8"
  style={{
    color: "#6c47ff",
  }}
...
>
  <img
    ...
    alt="Clerk Logo"
    className="rounded-xl w-24 dark:grayscale dark:bg-[#f0f4f9] px-6 py-4"
  />
  <span className="text-sky-600">Clerk - More than authentication.</span>
</a>

## 🥇 Gold sponsors

We don't have any gold sponsor yet 🥲 , [become the first one!](#become-a-sponsor).
...
<div className="flex flex-row gap-16 pt-8">
  {[
    ...
    [
      "https://workos.com",
      "https://avatars.githubusercontent.com/u/47638084?s=200&v=4",
      "WorkOS",
    ],
  ].map(([href, src, name]) => (
    <a
