...
<Callout>
  ...
  application, check out [session management](/getting-started/session-management) for more
  details.
</Callout>
...
<Callout type="info">
  ...
  interface](/getting-started/typescript#module-augmentation) to match the response of your
