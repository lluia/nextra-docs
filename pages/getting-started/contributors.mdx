...
[Balázs Orbán](https://github.com/balazsorban44) first joined as a co-maintainer and later became the lead maintainer of the project.
...
Based on NextAuth.js, [Balázs Orbán](https://github.com/balazsorban44) created Auth.js (`@auth/core`), a runtime/framework independent core library that is the base of
...
Due to personal reasons, Balázs Orbán had to step down as the lead maintainer, but was still contributing. The project was taken over by [Thang Huu Vu](https://github.com/thanghuuvu) for a while.
...
The new default documentation page became [authjs.dev](authjs.dev) (the one you are reading right now), and the old NextAuth.js documentation at [next-auth.js.org](https://next-auth.js.org) was kept around
to document NextAuth.js v4.
