...
var _a = require("broken-link-checker"), reasons = _a.reasons, SiteChecker = _a.SiteChecker;
var setFailed = require("@actions/core").setFailed;
...
function brokenLinkChecker() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            siteChecker = new SiteChecker(options)
                ...
                if (result.broken && result.reason !== reasons.HTTP_404) {
